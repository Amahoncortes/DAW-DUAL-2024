...
// Si existe la cesta en la sesión, obtiene los productos de la cesta
...
<body style="background: gray">
    <!-- Incluye la vista del encabezado -->
    ...
    <div class="container mt-3">
        <div class="card text-white bg-success mb-3 m-auto" style="width:40rem">
            <div class="card-body">
                ...
                ?>
                <!-- Enlaces para volver a la lista de productos y para pagar -->
