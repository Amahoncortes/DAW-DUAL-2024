...
console.log(divsRojos[1].className);
...
//Seleccionar elementos por su clase css
var divsNuevos=document.getElementsByClassName('azul');
console.log(divsNuevos);
for (let clase in divsNuevos){
   if (divsNuevos[clase].className == "azul")
        divsNuevos[clase].style.color="blue";
}
