...
require_once dirname(__FILE__, 2) . DIRECTORY_SEPARATOR . 'config'.DIRECTORY_SEPARATOR. 'config.php'; //obtenemos el fichero config.php
...
$controller = new $controllerName();  //Nuevo objeto
