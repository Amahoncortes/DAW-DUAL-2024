...
call agregarAgente( 311, 'Pedro Fernández Arias', 'pfa', 'agente311', 5, 0, 31, NULL);
call agregarAgente( 312, 'Vanesa Sánchez Rojo', 'vsr', 'agente312', 5, 0, 31, NULL);
call agregarAgente( 313, 'Francisco Javier García Escobedo', 'fjge', 'agente313', 5, 0, 31, NULL);
call agregarAgente( 314, 'Pilar Ramirez Pérez', 'prp', 'agente314', 5, 0, 31, NULL);
call agregarAgente( 315, 'José Luis García Martínez', 'jlgm', 'agente315', 5, 0, 31, NULL);
call agregarAgente( 21, 'Sebastián López Ojeda', 'slo', 'sup21', 9, 2, NULL, 2);
call agregarAgente( 211, 'Diosdado Sánchez Hernández', 'dsh', 'agente211', 8, 1, 21, NULL);
call agregarAgente( 2111, 'José Juan Cano Pardo', 'jjcp', 'agente2111', 5, 0, 211, NULL);
call agregarAgente( 2112, 'Flor Moncada Añón', 'agente2112', 'fma', 5, 0, 211, NULL);
call agregarAgente( 2113, 'Juan Manuel Alcazar Donaire', 'jmad', 'agente2113', 5, 0, 211, NULL);
call agregarAgente( 2121, 'Manuel Jesús Rubia Mateos', 'mjrm', 'agente2121', 5, 0, 212, NULL);
call agregarAgente( 2122, 'Esther López Delgado', 'eld', 'agente2122', 5, 0, 212, NULL);
call agregarAgente( 2123, 'Francisco Javier Cabrerizo Membrilla', 'fjcm', 'agente2123', 5, 0, 212, NULL);
call agregarAgente( 2124, 'Verónica Cabrerizo Menbrilla', 'vcm', 'agente2124', 5, 0, 212, NULL);
call agregarAgente( 2125, 'María José Navascués Morales', 'mjnm', 'agente2125', 5, 0, 212, NULL);
call agregarAgente( 2131, 'Isabel Cruz Granados', 'icg', 'agente2131', 5, 0, 213, NULL);
call agregarAgente( 2132, 'Antonio Casado Fernández', 'acf', 'agente2132', 5, 0, 213, NULL);
call agregarAgente( 2133, 'Gabriel Callejón García', 'gcg', 'agente2133', 5, 0, 213, NULL);
call agregarAgente( 2134, 'Enrique Cano Balsera', 'ecb', 'agente2134', 5, 0, 213, NULL);
call agregarAgente( 11, 'Narciso Jáimez Toro', 'njt', 'sup11', 9, 2, NULL, 1);
call agregarAgente( 111, 'Jesús Baños Sancho', 'jbs', 'agente111', 8, 1, 11, NULL);
call agregarAgente( 1111, 'Salvador Romero Villegas', 'srv', 'agente1111', 7, 1, 111, NULL);
call agregarAgente( 1112, 'José Javier Bermúdez Hernández', 'jjbh', 'agente1112', 7, 1, 111, NULL);
call agregarAgente( 1113, 'Alfonso Bonillo Sierra', 'abs', 'agente1113', 7, 1, 111, NULL);
call agregarAgente( 1121, 'Silvia Thomas Barrós', 'stb', 'agente1121', 7, 1, 112, NULL);
call agregarAgente( 11211, 'Ernesto Osoro Gorrotxategi', 'eog', 'agente11211', 5, 0, 1121, NULL);
call agregarAgente( 11212, 'Guillermo Campos Guillén', 'gcag', 'agente11212', 5, 0, 1121, NULL);
call agregarAgente( 11213, 'Antonio Fernández Ruíz', 'afr', 'agente11213', 5, 0, 1121, NULL);
call agregarAgente( 11214, 'María Luisa López Caballero', 'mllc', 'agente11214', 5, 0, 1121, NULL);
call agregarAgente( 11221, 'Virginia Morenas Rubio', 'vmr', 'agente11221', 5, 0, 1121, NULL);
call agregarAgente( 11222, 'Rosario Castro García', 'rcg', 'agente11222', 5, 0, 1122, NULL);
call agregarAgente( 11223, 'Antonio Álvarez Palomeque', 'aap', 'agente11223', 5, 0, 1122, NULL);
call agregarAgente( 11224, 'David Martínez Martínez', 'dmm', 'agente11224', 5, 0, 1122, NULL);
call agregarAgente( 11225, 'Juan Corral González', 'jcg', 'agente11225', 5, 0, 1122, NULL);
call agregarAgente( 11226, 'Eduardo Alfada Pereira', 'eap', 'agente11226', 5, 0, 1122, NULL);
call agregarAgente( 11231, 'Cayetano García Herrera', 'cgh', 'agente11231', 5, 0, 1123, NULL);
call agregarAgente( 11232, 'José Antonio Sieres Vega', 'jasv', 'agente11232', 5, 0, 1123, NULL);
call agregarAgente( 11233, 'Juan Manuel Guzmán García', 'jmgg', 'agente11233', 5, 0, 1123, NULL);
